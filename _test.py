...
def test_power():
    assert power(2) == 32, "Test Failed: The power of 2 should be 32"
    assert power(3) == 243, "Test Failed: The power of 3 should be 243"
    assert power(4) == 1024, "Test Failed: The power of 4 should be 1024"
